...
export default function WorkerCard({ worker }) {
  ...
  return (
    <div
      ...
      className="relative flex flex-col justify-between p-5 overflow-hidden transition-all duration-200 bg-white border border-gray-100 shadow-sm cursor-pointer rounded-2xl hover:shadow-md"
    >
      ...
      <div className="flex flex-col items-center mt-2 text-center">
        ...
        <h3 className="mb-1 text-lg font-bold text-gray-900">{worker.name}</h3>
