...
export default function TechnicianProfile() {
  ...
  const handleBookingSubmit = async (e) => {
    ...
    const description = `الخدمة المطلوبة: ${selectedSvcObject?.title || "خدمة عامة"}. ملاحظات: ${notes || "لا توجد"}`;
    const categoryId = profile?.category?._id || profile?.category;
    ...
    try {
      await createOrder({
        ...
        orderData: {
          ...
          description,
          phone: clientPhone,
          preferredTime: urgency === "urgent" ? "عاجل وطارئ جداً" : "عادي (غير مستعجل)",
          location: address,
        },
      }).unwrap();
    ...
    return (
      <div className="pt-18 min-h-screen flex items-center justify-center bg-gray-50/50">
        <div className="text-center space-y-4">
          <div className="w-12 h-12 border-4 border-[#F26B1D] border-t-transparent rounded-full animate-spin mx-auto"></div>
    ...
    return (
      <div className="pt-20 min-h-screen flex items-center justify-center bg-gray-50/50" dir="rtl">
        <div className="max-w-md w-full bg-white p-8 rounded-2xl border border-gray-100 shadow-sm text-center space-y-5">
          ...
          <Link
            to="/client-home"
            className="inline-block bg-[#F26B1D] hover:bg-[#d95914] text-white px-6 py-2.5 rounded-xl text-sm font-semibold transition-colors shadow-sm"
          >
            العودة للرئيسية
          </Link>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
              {/* Header banner */}
              <div className="h-20 bg-gradient-to-l from-orange-500 to-amber-600 relative overflow-hidden">
              ...
              <div className="px-6 pb-6 relative z-10">
                ...
                <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 -mt-14 mb-6">
                  <div className="flex items-end gap-4">
                    {/* Avatar */}
                    <div className="w-28 h-28 rounded-2xl bg-gradient-to-br from-orange-100 to-amber-50 border-4 border-white shadow-lg flex items-center justify-center text-3xl font-extrabold text-[#F26B1D] shrink-0 overflow-hidden">
                      {avatarUrl ? (
                    ...
                    <div className="mb-1">
                      ...
                      <p className="text-sm text-orange-600 font-semibold">{profile.category?.name || "حرفي"}</p>
                    </div>
                  </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3.5">
                  <div className="w-10 h-10 rounded-xl bg-blue-50 text-blue-600 flex items-center justify-center shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                  </div>
                  <div>
